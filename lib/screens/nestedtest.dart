...
class _NestedElement extends StatelessElement
  ...
  @override
  Widget build() {
    print(" _NestedElement  build invoke");
    ...
    print(" _NestedElement  nodes size is=="+nodes.length.toString());
    if (nestedHook != null) {
...
class _NestedHookElement extends StatelessElement {
  ...
  void mount(Element? parent, dynamic newSlot) {
    ...
    print(_wrappedChild.toString()+ "_NestedHookElement mount is invoke "+ widget.owner.nodes.length.toString());
  ...
  @override
  Widget build() {
    print("_NestedHookElement build is invoke wrappedChild=="+wrappedChild!.toString());
    return wrappedChild!;
  }
}
...
mixin SingleChildWidgetElementMixin on Element {
  ...
  void mount(Element? parent, dynamic newSlot) {
    if (parent is _NestedHookElement?) {
      _parent = parent;
      print("NextElement mount is invoke parent=" + _parent!._wrappedChild!.toString());
    }
    super.mount(parent, newSlot);
  }
...
class SingleChildStatelessElement extends StatelessElement
  ...
  Widget build() {
    if (_parent != null) {
      print("_parent==="+ _parent!._wrappedChild.toString());
